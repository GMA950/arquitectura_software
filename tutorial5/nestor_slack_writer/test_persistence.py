from persistence import connect_database, get_mongo_port, get_database_name, write_message_in_database, connect_rabbitmq
import pytest
...
@pytest.fixture
def collection_name():
    return "test_persistence" # por ahora
...
def test_write_message_in_database(database_name, collection_name):
    ...
    assert nb_doc_before == nb_doc_after -1
